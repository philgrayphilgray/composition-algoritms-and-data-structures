...
describe('_', () => {
  ...
  describe('`.reduce`', () => {
    ...
    it('should set the first value of the array as the initial value if none is provided', () => {
      const arr = [1, 2, 3, 4];
      const expected = 10;
      const sum = (acc, curr) => acc + curr;
  ...
  describe.skip('`.curry`', () => {
    it('should return a new function for each argument', () => {
  ...
  describe.skip('`compose`', () => {
    it('it should return each function provided as the argument to the next function, from right to left', () => {});
  });
});
